...
<section class="content">
    <div class="row">
        <div class="container p-3">
            ...
            <form class="row g-3 needs-validation" action='../../controller/capacitacion/create.php' method="POST"
                novalidate>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" id="tiempo_capa" name="tiempo_capa" required>
                    <div class="invalid-feedback">
                    Escriba un tiempo.
                    </div>
                </div>
